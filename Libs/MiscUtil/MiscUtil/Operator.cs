...
namespace MiscUtil
{
    ...
    public static class Operator
    {
		...
		//////////////// NEW OPERATORS DEFINED BY MAHDI
		public static T ModPow<T>(T value1, int value2, T value3)
		{
			return Operator<T>.ModPow(value1, value2, value3);
		}	
    }
    /// <summary>
    ...
    public static class Operator<T>
    {
		...
		//////////////// NEW OPERATORS DEFINED BY MAHDI
		static readonly Func<T, int, T, T> modPow;
		public static Func<T, int, T, T> ModPow { get { return modPow; } }
        ...
        static Operator()
        {
			...
			// Added by Mahdi
			modPow = ExpressionUtil.CreateExpression<T, T, T>(Expression.PowerAssign);
