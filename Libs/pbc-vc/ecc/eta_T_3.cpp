...
static void point_random(element_t a) {
	...
	pairing_data_ptr dp = (pairing_data_ptr)pairing->data;
...
static void eta_T_3_init_pairing(pairing_t pairing, params *p) {
	...
	pairing_data_ptr dp = (pairing_data_ptr)pbc_malloc(sizeof(*dp));
    mpz_init(dp->n2);
    mpz_set(dp->n2, p->n2);
