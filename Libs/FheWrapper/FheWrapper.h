...
namespace FheLib
{
	...
	private:
		...
		static array<int> ^mods = { 11, 13, 17, 19, 23, 25, 27, 28, 29, 31 };
	...
	public:
		...
		static vector<long> FindMods(long long x, array<int> ^ms, int size);

		/// <summary>
		/// Solves the Chinese Remainder Theorem problem.
		/// </summary>		
		static long long SolveCrt(vector<long> v, array<int> ^ms);
	};
}
